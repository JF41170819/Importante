...
int main()
{
    ...
    while(continuar=='s')
    {
        ...
        printf("%c%c                         %c%c\n",c,c,c,c);
        printf("%c%c SISTEMA DE COCHERA v1.0 %c%c\n",c,c,c,c);
        printf("%c%c                         %c%c\n",c,c,c,c);
        printf("%c%c1- Alta de due%co         %c%c\n",c,c,n,c,c);
        printf("%c%c2- Modificacion de due%co %c%c\n",c,c,n,c,c);
        printf("%c%c3- Ingreso del automovil %c%c\n",c,c,c,c);
        printf("%c%c4- Egreso del automovil  %c%c\n",c,c,c,c);
        printf("%c%c5- Informar              %c%c\n",c,c,c,c);
        printf("%c%c6- Salir                 %c%c\n",c,c,c,c);
        printf("%c%c                         %c%c\n",c,c,c,c);
        printf("%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c\n",c,c,c,c,c,c,c,c,c,c,c,c,c,c,c,c,c,c,c,c,c,c,c,c,c,c,c,c,c);
        printf("\n");
